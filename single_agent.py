...
class CheckAgent:
    ...
    # ---------- ReAct loop ----------
    async def react_loop(self, query: str) -> Tuple[str, List[str]]:
        """
    ...
    async def process_claim(self, idx, claim: str) -> Dict:
        ...
        answer, history, tool_cal_num = await self.react_loop(claim)
...
async def main():
    ...
    parser.add_argument("--dataset", default="factool_qa",
    ...
    parser.add_argument("--memory-file", type=str, default="memory/factool_evidence_memory.json",
    ...
    # Initialize logging
    log_file_path = os.path.join(args.log_file, f"{args.dataset}_{model_name}_single_agent.log")
    ...
    output_path = f"results/{args.dataset}_{model_name}_single_agent.json"
