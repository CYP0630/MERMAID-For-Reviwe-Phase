...
{{"thought": "your reasoning", "answer": "SUPPORTED"}}
or
{{"thought": "your reasoning", "answer": "NOT_SUPPORTED"}}
...
async def main():
    ...
    parser.add_argument("--dataset", default="hover2",
                        choices=["factscore", "factool_qa", "factcheckbench", "bingcheck", "hover2"], help="Dataset")
    ...
    parser.add_argument("--memory-file", type=str, default="memory/hover_evidence_memory.json",
